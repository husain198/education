...
<head>
  ...
  <title><?php echo @$title? @$title : 'Education'; ?> </title>
      ...
      <div id="login" class="animate form">
        <section class="login_content">
          <form>
            ...
            <div>
              <a class="btn btn-default submit" href="<?php echo base_url();?>admin/dashboard">Log in</a>
      ...
      <div id="register" class="animate form">
        <section class="login_content">
          <form>
            ...
            <div>
              <a class="btn btn-default submit" href="<?php echo base_url();?>admin/dashboard">Submit</a>
            </div>
            <div class="clearfix"></div>
            <div class="separator">
